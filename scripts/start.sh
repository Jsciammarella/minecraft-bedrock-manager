...
mkdir -p "${DATA_DIR}/catalog/addons"
mkdir -p "${DATA_DIR}/catalog/maps"
mkdir -p "${DATA_DIR}/catalog/texture-packs"
mkdir -p "${DATA_DIR}/catalog/skins"
mkdir -p "${DATA_DIR}/catalog/scripts"
