...
`);
  ...
  deleteApp.use((req, _res, next) => { req.user = { id: 1, username: 'test-admin', isAdmin: true }; next(); });
  ...
  authApp.use((req, _res, next) => { req.user = { id: 1, username: 'test-admin', isAdmin: true }; next(); });
