...
.SYNOPSIS
  ...
  (for example MinecraftBedrockManager-0.3.9_0001.exe). The product version
  stays 0.3.9 until you pass -Version; the build number increments automatically.
...
# MSI ProductVersion is only x.y.z. Burn can use a fourth field so 0.3.9_0002 replaces 0.3.9_0001.
